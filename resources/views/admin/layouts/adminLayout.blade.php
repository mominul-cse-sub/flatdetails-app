                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu profileInfoContainer dropdown-menu-end"
                                    ...
                                    <div class="card text-center">
                                        <img src="/images/avatar.jpg" class="card-img-top rounded-circle mx-auto mt-4"
        ...
        <main class="container-fluid">
            <div class="row">
                <div class="col-2 leftSidebar p-0">
                    <a class="navbar-brand shadow-sm" href="{{ url('/admin') }}">
                        {{ config('app.name', 'Laravel') }}
                    </a>
                    <ul>
                        <li class=""><a href="flat">Dashboard</a>
                        </li>
                        <li class=""><a href="{{ route('admin.flatowner') }}">All Flat Owner List</a></li>
                        <li class=""><a href="{{ route('admin.tenant') }}">All Tenant List</a></li>
                        <li class=""><a href="#">All Flat List</a></li>
                        <li class=""><a href="#">All Deleted Flat List</a></li>
